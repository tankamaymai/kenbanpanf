...
const CoverV1 = () => (
  <section className="page cover cover-v1" data-screen-label="00 表紙">
    <div className="spine" />
    <div className="top">
      <img className="logo" src="assets/img/logo.svg" alt="新小文字病院 整形外科"/>
...
const CoverV2 = () => (
  <section className="page cover cover-v2" data-screen-label="00 表紙">
    <div className="photo" style={{backgroundImage:"url('assets/img/brace-front2.jpg')"}}>
      <div className="eyebrow">PATIENT GUIDE</div>
      <img className="logo-mini" src="assets/img/logo.svg" alt="仁誠会" />
    </div>
    <div className="body">
      <div>
...
const CoverV3 = () => (
  <section className="page cover cover-v3" data-screen-label="00 表紙">
    ...
    <div className="grid">
      <div className="left">
        <div>
          <img className="logo" src="assets/img/logo.svg" alt="仁誠会" />
      ...
      <div className="right">
        ...
        <div className="toc">
          ...
          <div className="toc-item"><span className="toc-num">07</span><span className="toc-title">外転枕終了後｜鞄・ポケットの工夫</span><span className="toc-page">P.08</span></div>
          <div className="toc-item"><span className="toc-num">08</span><span className="toc-title">外転枕終了後｜洗濯物を干す</span><span className="toc-page">P.09</span></div>
          <div className="toc-item"><span className="toc-num">09</span><span className="toc-title">自主トレ ①振り子・握力</span><span className="toc-page">P.10</span></div>
          <div className="toc-item"><span className="toc-num">10</span><span className="toc-title">自主トレ ②他動可動域</span><span className="toc-page">P.11</span></div>
          <div className="toc-item"><span className="toc-num">11</span><span className="toc-title">自主トレ ③自動・筋力</span><span className="toc-page">P.12</span></div>
          <div className="toc-item"><span className="toc-num">12</span><span className="toc-title">Q&amp;A よくあるご質問</span><span className="toc-page">P.13</span></div>
        </div>
      </div>
    </div>
  </section>
