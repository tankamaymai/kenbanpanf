...
const PagePathology = () => (
  <Page num={4} kicker="CHAPTER 03 ／ 再断裂について" title="なぜ再断裂に注意が必要？" style={{padding:"40px 52px 60px", background:"#fff"}}>
...
const PageSurgery = () => (
  <Page num={5} kicker="CHAPTER 04 ／ 手術" title="手術について">
    ...
    <div className="grid-a45">
      <div>
        <PhotoCard src="assets/img/wound.jpg" title="手術創部の一例" ratio="4/3" objectPosition="center 45%">
